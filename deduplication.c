...
// Compares data in 2 text files
int compare_files(const char *fname1, const char *fname2);

// Checks if the file is a wav file
...
// Gives the number of files in the folder
int noof_files (const char *path);

// Deletes the required file
void deleteFile(char *path);

// Deletes all the text files generated containing the data
