...
void dft(int *x[], unsigned int samples_per_frame);
...
void calculate_mfcc(double spectrum[], const char *fname,double *mfcc_result[], unsigned int i, unsigned int samples_per_frame);
...
void wave_Read(const char* input_file)
{
        ...
        else
        {
                ...
                int *buff16=(int *)malloc(BUFSIZE*sizeof(int));
                int *amplitude_data[FRAMES_25ms];

                for (i = FRAMES_25ms; i-- ; )
                {
                        amplitude_data[i] = (int *)malloc(samples_per_frame * sizeof(int));
                ...
                dft((int **)amplitude_data, samples_per_frame);
 ...
 *
 */
void calculate_mfcc(double spectrum[], const char *mfcc_txt, double *mfcc_result[], unsigned int i, unsigned int samples_per_frame)
{
